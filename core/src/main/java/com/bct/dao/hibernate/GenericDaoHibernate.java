...
import com.bct.dao.GenericDao;
import com.bct.dao.SearchException;
 ...
 * <pre>
 *      &lt;bean id="fooDao" class="com.bct.dao.hibernate.GenericDaoHibernate"&gt;
 *          &lt;constructor-arg value="com.bct.model.Foo"/&gt;
 *      &lt;/bean&gt;
 * </pre>
 *
...
public class GenericDaoHibernate<T, PK extends Serializable> implements GenericDao<T, PK> {
    ...
    @Resource    
    private SessionFactory intSessionFactory;
    
    @Resource    
    private SessionFactory extSessionFactory;
    ...
    public GenericDaoHibernate(final Class<T> persistentClass, SessionFactory sessionFactory) {
        this.persistentClass = persistentClass;
        this.intSessionFactory = sessionFactory;
        defaultAnalyzer = new StandardAnalyzer(Version.LUCENE_35);
    }

    public SessionFactory getSessionFactory() {
        return this.intSessionFactory;
    }
    ...
    public SessionFactory getExtSessionFactory() {
		return this.extSessionFactory;
	}

    @Autowired
    @Qualifier(value="extSessionFactory")
    @Required
	public void setExtSessionFactory(SessionFactory extSessionFactory) {
		this.extSessionFactory = extSessionFactory;
	}
